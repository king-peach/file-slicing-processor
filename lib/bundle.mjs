...
var FileSlicingProcessor = /** @class */ (function () {
    function FileSlicingProcessor(file, options) {
        var _this = this;
        /* 文件分片阈值 */
        ...
        var md5 = "".concat(file.name, "-").concat(file.size, "-").concat(file.lastModified);
        var now = new Date().getTime();
        var id = SparkMD5.hash(now + md5);
        this.fileInfo = {
            id: id,
            md5: md5,
            name: file.name,
        ...
        if (this.uploadedChunkNum && this.uploadedChunkNum > this.fileInfo.totalChunks) {
            var error = new Error('The uploadedChunkNum parameter more than file chunk total!');
        }
        this.file = file;
    }
    FileSlicingProcessor.prototype.getFileRealMD5 = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var spark = new SparkMD5.ArrayBuffer(), currChunk = 0;
            var fileReader = new FileReader();
            fileReader.onload = function (e) {
                spark.append(e.target.result);
                currChunk++;
                if (currChunk < _this.fileInfo.totalChunks) {
                    loadNext();
                }
                else {
                    var md5 = spark.end();
                    spark = null;
                    resolve(md5);
                    _this.fileInfo.md5 = md5;
                    _this.onFileMD5Progress && _this.onFileMD5Progress(Math.ceil(currChunk / _this.fileInfo.totalChunks * Math.pow(10, 4)) / Math.pow(10, 2));
                }
            };
            fileReader.onerror = function (err) { return reject(err); };
            var loadNext = function () {
                fileReader.readAsArrayBuffer(_this.handleFileSlice(currChunk, currChunk + 1));
                _this.onFileMD5Progress && _this.onFileMD5Progress(Math.ceil(currChunk / _this.fileInfo.totalChunks * Math.pow(10, 4)) / Math.pow(10, 2));
            };
            loadNext();
        });
    ...
    FileSlicingProcessor.prototype.getChunkMD5 = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var chunk = _this.getChunk();
            var fileReader = new FileReader();
    ...
    FileSlicingProcessor.prototype.reStart = function (num) {
        if (num === void 0) { num = 0; }
